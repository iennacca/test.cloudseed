...
const PrivacyPage = () => {
	return (
		<Layout title="CloudSeed">
			<div className="max-w-7xl mx-auto py-4 px-10 sm:px-6 lg:py-20 lg:px-10">
				<h1 className="text-4xl">Privacy Policy</h1>
				Updated: 2022.02.05
				<p>Your privacy is important to us. It is HAMY LABS&#39; policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://cloudseed.xyz">https://cloudseed.xyz</a>, and other sites we own and operate. </p>
				<div className="py-1">
					<h2 className="text-2xl">Overview</h2>
					<p>
					This license is a legal agreement between you and HAMY LABS LLC for the use of CloudSeed Software (the “Software”). By downloading any CloudSeed files, add-ons, or resources, you agree to be bound by the terms and conditions of this license. HAMY LABS LLC reserves the right to alter this agreement at any time, for any reason, without notice.
					</p>
				</div>
				...
				<h4 className="text-xl">Log Data</h4>
				...
				<h4 className="text-xl">Legitimate Reasons for Processing Your Personal Information</h4>
				...
				<h4 className="text-xl">Collection and Use of Information</h4>
				...
				<h3 className="text-2xl">Use of Cookies</h3>
